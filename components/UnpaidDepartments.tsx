...
const UnpaidDepartments: React.FC<UnpaidDepartmentsProps> = ({ records }) => {
  ...
  // This list is duplicated in other components. For this task, duplication is acceptable.
  // In a refactor, this should be moved to a shared constants file.
  const ministryDepartments: Record<string, string[]> = {
    ...
    'وزارة التربية': ['مديرية تربية البصرة'], 'وزارة الصحة': ['دائرة صحة البصرة'],
