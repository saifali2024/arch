...
const ArchiveSearch: React.FC<ArchiveSearchProps> = ({ records }) => {
  ...
  const ministryDepartments: Record<string, string[]> = {
    'رئاسة الوزراء': [
      'مديرية شهداء البصرة', 'مديرية شهداء شمال البصرة', 'مديرية الوقف الشيعي في البصرة',
      'هيئة إدارة واستثمار أموال الوقف السني المنطقة الجنوبية', 'مديرية الوقف السني المنطقة الجنوبية'
    ],
    'مجلس القضاء الأعلى': ['رئاسة محكمة استئناف البصرة'],
    'محافظة البصرة': [
      'مديرية بلدية البصرة', 'مديرية بلديات محافظة البصرة', 'مديرية بلدية الدير', 'مديرية بلدية الهارثة',
      'مديرية بلدية النشوة', 'مديرية بلدية ابي الخصيب', 'مديرية بلدية السيبة', 'مديرية بلدية سفوان',
      'مديرية بلدية المدينة', 'مديرية بلدية الفاو', 'مديرية بلدية عزالدين سليم', 'مديرية بلدية شط العرب',
      'مديرية بلدية القرنة', 'مديرية بلدية الزبير', 'مديرية بلدية الثغر', 'مديرية بلدية الصادق',
      'مديرية بلدية ام قصر', 'ديوان محافظة البصرة', 'مجلس محافظة البصرة', 'مديرية ماء البصرة',
      'مديرية مجاري البصرة', 'المركز الوطني للصحة والسلامة المهنية في البصرة', 'مديرية زراعة البصرة',
      'هيئة استثمار البصرة', 'مديرية طرق وجسور البصرة', 'هيئة رعاية ذوي الإعاقة والاحتياجات الخاصة',
      'دائرة المباني البصرة', 'مديرية التخطيط العمراني', 'دائرة العمل والتدريب المهني البصرة',
      'مديرية شباب ورياضة البصرة', 'دائرة الإسكان في البصرة'
    ],
    'وزارة التربية': ['مديرية تربية البصرة'],
    'وزارة الصحة': ['دائرة صحة البصرة'],
    'وزارة الاتصالات': ['مديرية اتصالات ومعلوماتية البصرة'],
    'وزارة التجارة': [
      'الشركة العامة لتجارة الحبوب / فرع البصرة', 'الشركة العامة لتجارة الحبوب / فرع ام قصر',
      'الشركة العامة لتصنيع الحبوب /البصرة', 'الشركة العامة لتجارة السيارات والمكائن فرع البصرة',
      'الشركة العامة لتجارة المواد الغذائية فرع البصرة'
    ],
    'وزارة التخطيط': ['مديرية إحصاء البصرة', 'الجهاز المركزي للتقييس والسيطرة النوعية قسم البصرة'],
    'وزارة التعليم العالي': [
      'رئاسة جامعة البصرة', 'الجامعة التقنية الجنوبية', 'الكلية التقنية الهندسية البصرة',
      'الكلية التقنية الإدارية البصرة', 'كلية التقنيات الطبية والصحية البصرة', 'المعهد التقني البصرة',
      'المعهد التقني القرنة', 'جامعة البصرة للنفط والغاز'
    ],
    'وزارة الداخلية': [
      'قيادة حرس حدود المنطقة الرابعة', 'مديرية الأحوال المدنية والجوازات والإقامة في البصرة',
      'مديرية الدفاع المدني البصرة', 'مديرية شرطة كمارك المنطقة الرابعة', 'امرية حرس حدود السواحل',
      'مدرسة تدريب حدود المنطقة الجنوبية', 'مقر لواء حرس حدود الرابع عشر', 'مقر لواء حرس حدود السادس عشر',
      'اكاديمية الخليج العربي للدراسات البحرية', 'مديرية مرور محافظة البصرة', 'مديرية شرطة محافظة البصرة والمنشأت'
    ],
    'وزارة الزراعة': ['مستشفى البيطرة البصرة'],
    'وزارة الصناعة والمعادن': [
      'الشركة العامة لصناعة الاسمدة الجنوبية', 'شركة ابن ماجد العامة', 'معمل اسمنت البصرة',
      'الشركة العامة للصناعات البتروكيمياوية', 'الشركة العامة للحديد والصلب'
    ],
    'وزارة العدل': [
      'مديرية رعاية القاصرين في البصرة', 'سجن البصرة المركزي', 'مديرية التسجيل العقاري في البصرة الأولى',
      'مديرية التسجيل العقاري في البصرة الثانية', 'مديرية تنفيذ البصرة', 'دائرة كاتب عدل البصرة'
    ],
    'وزارة العمل والشؤون الاجتماعية': ['شبكة الحماية الاجتماعية في البصرة', 'دائرة التقاعد والضمان الاجتماعي البصرة']
  };
